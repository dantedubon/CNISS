...
namespace CNISS_Integration_Test.Repositories.EmpleoRepository.Commands
{
    ...
    public class when_UserUpdatesBeneficiarioEmpleo_Should_UpdatesEmpleo
    {
        ...
        private static Beneficiario _nuevoBeneficiario;
        ...
        private Establish context = () =>
        {
            ...
            _nuevoBeneficiario = getBeneficiario2();
            ...
            prepareBeneficiario(_nuevoBeneficiario);
        ...
        private Because of = () =>
        {
            _expectedEmpleo.beneficiario = _nuevoBeneficiario;
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                var repository = new EmpleoRepositoryCommands(uow.Session);
        ...
        private static Beneficiario getBeneficiario2()
        {
            var beneficiario = new Beneficiario(new Identidad("0801199766666"),
                new Nombre("Inigo", "Montoya", "Velasquez"), new DateTime(1984, 8, 2));
