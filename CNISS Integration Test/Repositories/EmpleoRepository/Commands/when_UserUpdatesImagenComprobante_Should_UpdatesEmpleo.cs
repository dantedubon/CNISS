...
namespace CNISS_Integration_Test.Repositories.EmpleoRepository.Commands
{
    ...
    public class when_UserUpdatesImagenComprobante_Should_UpdatesEmpleo
    {
        ...
        private static ContentFile _imagenComprobante1;
        private static ContentFile _imagenComprobante2;
        private static ComprobantePago _comprobantePagoWithImage;
        private static ComprobantePago _comprobantePagoWithOutImage;
        private Establish context = () =>
        {
            ...
            _comprobantePagoWithImage = getComprobantePagoWithImage();
            _comprobantePagoWithOutImage = getComprobantePagoWithOutImage();

            _expectedEmpleo.addComprobante(_comprobantePagoWithImage);
            ...
            _imagenComprobante1 = new ContentFile(new byte[]{1,1,1});
            _imagenComprobante2 = new ContentFile(new byte[]{0,0,0});
        ...
        private static ComprobantePago getComprobantePagoWithOutImage()

        {
            return new ComprobantePago(new DateTime(2014, 8, 2), 100, 200, 100);
        }
