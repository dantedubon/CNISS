...
namespace CNISS_Integration_Test.Repositories.EmpleoRepository.ReadOnly
{
    ...
    public class when_UserAskEmpleoForNotaDespidoFechaNotaMenorAEmpleo_Should_ReturnFalse
    {
        ...
        private Establish context = () =>
        {
            ...
            _fechaNotaDespido = DateTime.Now.AddMonths(-2).Date;
            ...
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                repository.save(_recienteEmpleo);
                uow.commit();
            }
        ...
        private Because of = () =>
        {
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                var fechaBusqueda = DateTime.Now.Date;
                var diasBusqueda = 90;
                _response = repositoryRead.existsEmpleoForNotaDespido(_recienteEmpleo.Id, _fechaNotaDespido);
