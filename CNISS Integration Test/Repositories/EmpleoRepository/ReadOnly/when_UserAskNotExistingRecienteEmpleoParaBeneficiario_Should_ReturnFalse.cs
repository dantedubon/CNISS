...
namespace CNISS_Integration_Test.Repositories.EmpleoRepository.ReadOnly
{
    ...
    public class when_UserAskNotExistingRecienteEmpleoParaBeneficiario_Should_ReturnFalse
    {
        ...
        private Because of = () =>
        {
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                var diasBusqueda = 10;
                _response = repositoryRead.existsEmpleoRecienteParaBeneficiario(fechaBusqueda, diasBusqueda,
