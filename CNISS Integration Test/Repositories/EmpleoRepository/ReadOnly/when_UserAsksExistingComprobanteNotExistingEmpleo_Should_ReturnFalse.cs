...
namespace CNISS_Integration_Test.Repositories.EmpleoRepository.ReadOnly
{
    ...
    public class when_UserAsksExistingComprobanteNotExistingEmpleo_Should_ReturnFalse
    {
        ...
        private Because of = () =>
        {
            ...
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                _response = repository.existsComprobante(Guid.NewGuid(), _comprobantePago.Id);
