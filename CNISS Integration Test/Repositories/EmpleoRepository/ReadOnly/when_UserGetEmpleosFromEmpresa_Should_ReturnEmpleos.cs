...
namespace CNISS_Integration_Test.Repositories.EmpleoRepository.ReadOnly
{
    ...
    public class when_UserGetEmpleosFromEmpresa_Should_ReturnEmpleos
    {
        private static InFileDataBaseTest _dataBaseTest;
        private static ISessionFactory _sessionFactory;
        private static ISession _session;
        private static Empleo _empleoEmpresa;
        private static Empleo _responseEmpleo;
        private static bool _response;
        private static Identidad identidadBeneficiario;
        private static RTN _rtnEmpresa;
        ...
        private Establish context = () =>
        {
            ...
            identidadBeneficiario = beneficiario.Id;
            ...
            _empleoEmpresa = new Empleo(empresa, sucursal, beneficiario, horario, "Ingeniero", 25000, tipoEmpleo, fechaDeInicio);
            _empleoEmpresa.addComprobante(getComprobantePago());
            ...
            _rtnEmpresa = _empleoEmpresa.empresa.Id;
        ...
        private Because of = () =>
        {
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                repository.save(_empleoEmpresa);
                uow.commit();
            }
        };
        ...
        It should_return_true = () =>
        {
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                _responseEmpleo = repositoryRead.getEmpleosByEmpresa(_rtnEmpresa).First();
                _responseEmpleo.empresa.gremial.empresas = new List<Empresa>();
                _responseEmpleo.ShouldBeEquivalentTo(_empleoEmpresa);
            }
