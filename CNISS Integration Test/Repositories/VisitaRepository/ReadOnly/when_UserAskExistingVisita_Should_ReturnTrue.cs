...
namespace CNISS_Integration_Test.Repositories.VisitaRepository.ReadOnly
{
    ...
    public class when_UserAskExistingVisita_Should_ReturnTrue
    {
        ...
        private Because of = () =>
        {
            ...
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                _respuesta = repository.exists(_expectedVisita.Id);

            }
        };

        It should_return_true = () => _respuesta.Should().BeTrue();
