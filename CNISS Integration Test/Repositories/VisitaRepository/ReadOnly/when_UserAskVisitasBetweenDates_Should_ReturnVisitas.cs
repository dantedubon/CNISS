...
namespace CNISS_Integration_Test.Repositories.VisitaRepository.ReadOnly
{
    ...
    public class when_UserAskVisitasBetweenDates_Should_ReturnVisitas
    {
        private static InFileDataBaseTest _dataBaseTest;
        private static ISessionFactory _sessionFactory;
        private static ISession _session;
        private static Visita _visitaResponse;
        ...
        private Establish context = () =>
        {
            ...
            var usuarioSupervisor = new User("MRD", "Angel", "Rosa", "xxx", "xxx", new Rol("Rol prueba", "Rol de Prueba"));
        ...
        private It should_return_visita = () =>
        {
            using (var uow = new NHibernateUnitOfWork(_sessionFactory.OpenSession()))
            {
                ...
                _visitaResponse =
                    repository.visitasEntreFechas(_expectedVisita.FechaInicial, _expectedVisita.FechaFinal)
                        .FirstOrDefault();
                _visitaResponse.Id.ShouldBeEquivalentTo(_expectedVisita.Id);
