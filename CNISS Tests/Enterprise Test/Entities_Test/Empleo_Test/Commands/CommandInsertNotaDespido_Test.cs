...
namespace CNISS_Tests.Enterprise_Test.Entities_Test.Empleo_Test.Commands
{
    ...
    public class CommandInsertNotaDespido_Test
    {
        ...
        public void isExecutable_empleoNotExists_returnFalse()
        {
            ...
            Mock.Get(repositoryEmpleoRead).Setup(x => x.existsEmpleoAndFechaInicioMenorAFechaProporcionada(idEmpleo,nota.fechaDespido)).Returns(false);
        ...
        public void isExecutable_invalidFirma_returnFalse()
        {
            ...
            Mock.Get(repositoryEmpleoRead).Setup(x => x.existsEmpleoAndFechaInicioMenorAFechaProporcionada(idEmpleo, nota.fechaDespido)).Returns(true);
