...
namespace CNISS_Tests.Enterprise_Test.Entities_Test.Empleo_Test.Module
{
    ...
    public class when_UserGetEmpleoByEmpresaInvalidRTN_returnError
    {
        ...
        {
            _rtnRequest = new RTNRequest() { RTN = "08011985123961" };
        ...
        private Because of = () => { _response = _browser.GetSecureJson("/enterprise/empleos/empresa/id=" + _rtnRequest.RTN); };
