...
namespace CNISS_Tests.Enterprise_Test.Entities_Test.Empleo_Test.Module
{
    ...
    public class when_UserPostEmpleoValidEmpleoWithNoEmptyFileContractWithBadVoucherFiles_Should_ReturnError
    {
        ...
        private Establish context = () =>
        {
            ...
            Mock.Get(fileGetter)
                .SetupSequence(x => x.existsFile(Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<string>()))
                .Returns(true)
                .Returns(false);
        ...
        private Because of = () => { _response = _browser.PostSecureJson("/enterprise/empleos", _request); };
         ...
         It should_save_empleo = () => _response.StatusCode.ShouldEqual(HttpStatusCode.BadRequest);
