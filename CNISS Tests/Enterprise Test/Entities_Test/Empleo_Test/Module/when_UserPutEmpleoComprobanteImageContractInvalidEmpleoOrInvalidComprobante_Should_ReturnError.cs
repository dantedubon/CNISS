...
namespace CNISS_Tests.Enterprise_Test.Entities_Test.Empleo_Test.Module
{
    ...
    public class when_UserPutEmpleoComprobanteImageContractInvalidEmpleoOrInvalidComprobante_Should_ReturnError
    {
        ...
        private Establish context = () =>
        {
            ...
            Mock.Get(command).Setup(x => x.isExecutable(_empleoId, _comprobanteId)).Returns(false);
