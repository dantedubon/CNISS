...
namespace CNISS_Tests.Enterprise_Test.Entities_Test.Visita_Test.Module.Command
{
    ...
    public class when_UserPutVisitaExecutable_Should_UpdateVisita
    {
        ...
        private Establish context = () =>
        {
            ...
            _expectedVisita.Id = _request.guid;
            Mock.Get(_command)
        ...
        It should_update_visita =
            () => Mock.Get(_command).Verify(x => x.execute(Moq.It.Is<Visita>(z => z.Id == _expectedVisita.Id)));
