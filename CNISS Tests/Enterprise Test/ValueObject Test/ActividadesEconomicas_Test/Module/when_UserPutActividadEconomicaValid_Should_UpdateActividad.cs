...
namespace CNISS_Tests.Enterprise_Test.ValueObject_Test.ActividadesEconomicas_Test.Module
{
    ...
    public class when_UserPutActividadEconomicaValid_Should_UpdateActividad
    {
        ...
        private Establish context = () =>
        {
            ...
            Mock.Get(_command).Setup(x => x.isExecutable(Moq.It.Is<ActividadEconomica>(z => z.Id == _expectedActividadEconomica.Id))).Returns(true);
        ...
        It should_update_actividad = () => Mock.Get(_command).Verify(x => x.execute(Moq.It.Is<ActividadEconomica>(z => z.Descripcion == _expectedActividadEconomica.Descripcion
            && z.Id == _expectedActividadEconomica.Id
            )));
